...
public class PDFFilterProperties {
  ...
  /**
   * Returns the password that a user will need to change the permissions of the exported PDF, or
   * null if no permission password is set. The password is in clear text.
   *
   * @return the password that a user will need to change the permissions of the exported PDF, or
   * null if no permission password is set
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Set the password that a user will need to change the permissions of the exported PDF. The
   * password should be in clear text.
   *
   * @param permissionPassword the clear test password to be used, or null to not use a permission
   * password
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Returns the password you must know to open the PDF document, or null if no document open
   * password is set. The password is in clear text.
   *
   * @return the password you must know to open the PDF document, or null if no document open
   * password is set
   * @author Markus Krüger
   * @date 01.06.2010
   */
   ...
   *
   * @param documentOpenPassword the clear test password to be used, or null to not use a document
   * open password
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Returns the printing mode of the document: 0: PDF document cannot be printed 1: PDF document
   * can be printed at low resolution only 2: PDF document can be printed at maximum resolution
   *
  ...
  /**
   * Set the printing mode of the document: 0: PDF document cannot be printed 1: PDF document can be
   * printed at low resolution only 2: PDF document can be printed at maximum resolution
   *
  ...
  /**
   * Returns the changes mode allowed to the document: 0: PDF document cannot be changed 1:
   * Inserting, deleting and rotating pages is allowed 2: Filling of form field is allowed 3:
   * Filling of form field and commenting is allowed 4: All the changes of the previous selections
   * are permitted, with the only exclusion of page extraction
   *
  ...
  /**
   * Set the changes mode allowed to the document: 0: PDF document cannot be changed 1: Inserting,
   * deleting and rotating pages is allowed 2: Filling of form field is allowed 3: Filling of form
   * field and commenting is allowed 4: All the changes of the previous selections are permitted,
   * with the only exclusion of page extraction
   *
  ...
  /**
   * Returns if the pages and the PDF document content can be extracted to be used in other
   * documents: Copy from the PDF document and paste eleswhere.
   *
   * @return if the pages and the PDF document content can be extracted to be used in other
   * documents: Copy from the PDF document and paste eleswhere
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Set if the pages and the PDF document content can be extracted to be used in other documents:
   * Copy from the PDF document and paste eleswhere.
   *
   * @param enableCopyingOfContent if the pages and the PDF document content can be extracted to be
   ...
   *
   * @return if the PDF document content can be extracted to be used in accessibility applications
   * @author Markus Krüger
   * @date 01.06.2010
   */
   ...
   *
   * @param enableTextAccessForAccessibilityTools if the PDF document content can be extracted to be
   * used in accessibility applications
   * @author Markus Krüger
   * @date 01.06.2010
   */
  public void setEnableTextAccessForAccessibilityTools(
  ...
  /**
   * Returns which pages are exported to the PDF document. To export a range of pages, use the
   * format 3-6. To export single pages, use the format 7;9;11. Specify a combination of page ranges
   * and single pages by using a format like 2-4;6. If the document has less pages than defined in
   * the range, the result might be the exception "com.sun.star.task.ErrorCodeIOException". This
   * exception occured for example by using an ODT file with only one page and a page range of
   * "2-4;6;8-10". Changing the page range to "1" prevented this exception. For no apparent reason
   * the exception didn't occure by using an ODT file with two pages and a page range of
   * "2-4;6;8-10". Can return null if no range is specified.
   *
  ...
  /**
   * Set which pages are exported to the PDF document. To export a range of pages, use the format
   * 3-6. To export single pages, use the format 7;9;11. Specify a combination of page ranges and
   * single pages by using a format like 2-4;6. If the document has less pages than defined in the
   * range, the result might be the exception "com.sun.star.task.ErrorCodeIOException". This
   * exception occured for example by using an ODT file with only one page and a page range of
   * "2-4;6;8-10". Changing the page range to "1" prevented this exception. For no apparent reason
   * the exception didn't occure by using an ODT file with two pages and a page range of
   * "2-4;6;8-10". Can be set to null to not specify a range and print all pages.
   *
   * @param enableTextAccessForAccessibilityTools if the PDF document content can be extracted to be
   * used in accessibility applications
   * @author Markus Krüger
  ...
  /**
   * Returns the quality of the JPG export in a range from 0 to 100. A higher value results in
   * higher quality and file size. The value 100 results in a lossless compression.
   *
  ...
  /**
   * Set the quality of the JPG export in a range from 0 to 100. A higher value results in higher
   * quality and file size. The value 100 results in a lossless compression.
   *
  ...
  /**
   * Returns the DPI to reduce images to. If not -1 then all images will be reduced to the given
   * value in DPI. If -1 then no reduction will be used. Allowed values are -1, 75, 150, 300, 600,
   * 1200
   *
  ...
  /**
   * Set the DPI to reduce images to. If not -1 then all images will be reduced to the given value
   * in DPI. If -1 then no reduction will be used. Allowed values are -1, 75, 150, 300, 600, 1200
   *
  ...
  /**
   * Returns whether form fields are exported as widgets or only their fixed print representation is
   * exported.
   *
   * @return whether form fields are exported as widgets or only their fixed print representation is
   * exported
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Set whether form fields are exported as widgets or only their fixed print representation is
   * exported.
   *
   * @param exportFormFields whether form fields are exported as widgets or only their fixed print
   * representation is exported
   * @author Markus Krüger
   * @date 01.06.2010
   */
   ...
   *
   * @return if the PDF viewer window is centered to the screen when the PDF document is opened
   * @author Markus Krüger
   * @date 01.06.2010
   */
   ...
   *
   * @param centerWindow if the PDF viewer window is centered to the screen when the PDF document is
   * opened
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Returns the magnification to be performed when the PDF document is opened: 0: Opens with
   * default zoom magnification 1: Opens magnified to fit the entire page within the window 2: Opens
   * magnified to fit the entire page width within the window 3: Opens magnified to fit the entire
   * width of its boundig box within the window (cuts out margins) 4: Opens with a zoom level given
   * in the ueZoomue property.
   *
   * @return the magnification to be performed when the PDF document is opened
   * @author Markus Krüger
   * @date 01.06.2010
   */
   ...
   * zoom magnification 1: Opens magnified to fit the entire page within the window 2: Opens
   * magnified to fit the entire page width within the window 3: Opens magnified to fit the entire
   * width of its boundig box within the window (cuts out margins) 4: Opens with a zoom level given
   * in the ueZoomue property.
   *
   * @param magnificationMode the magnification to be performed when the PDF document is opened
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Returns the zoom level between 50 and 1600 a PDF document is opened with. Only valid if the
   * magnification mode is set to 4.
   *
   * @return the zoom level between 50 and 1600 a PDF document is opened with. Only valid if the
   * magnification mode is set to 4
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Set the zoom level between 50 and 1600 a PDF document is opened with. Only valid if the
   * magnification mode is set to 4.
   *
  ...
  /**
   * Returns if automatically inserted empty pages are suppressed. This option only applies for
   * storing Writer documents.
   *
   * @return if automatically inserted empty pages are suppressed. This option only applies for
   * storing Writer documents
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Set if automatically inserted empty pages are suppressed. This option only applies for storing
   * Writer documents.
   *
   * @param skipEmptyPages if automatically inserted empty pages are suppressed
   * @author Markus Krüger
   * @date 01.06.2010
   */
  ...
  /**
   * Returns the PDF version that should be generated: 0: PDF 1.4 (default selection) 1: PDF/A-1
   * (ISO 19005-1:2005).
   *
  ...
  /**
   * Set the PDF version that should be generated: 0: PDF 1.4 (default selection) 1: PDF/A-1 (ISO
   * 19005-1:2005).
   *
   ...
   *
   * @param additionalProps the additional property values that are not covered by this class
   * @author Markus Krüger
   * @date 01.06.2010
   */
