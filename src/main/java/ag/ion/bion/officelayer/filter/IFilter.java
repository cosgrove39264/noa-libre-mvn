...
public interface IFilter {
  ...
  /**
   * Returns definition of the filter. Returns null if the filter is not available for the submitted
   * document.
   *
   * @param document document to be exported
   * @return definition of the filter or null if the filter is not available for the submitted
   * document
   */
   ...
   * @return information whether the submitted document is supported by the filter
   * @author Andreas Bröker
   * @date 08.07.2006
   */
  ...
  /**
   * Returns information whether the submitted document type is supported by the filter.
   *
   * @param documentType document type to be used
   * @return information whether the submitted document type is supported by the filter
   * @author Markus Krüger
   * @date 13.03.2008
   */
  ...
  /**
   * Returns information whether the filter constructs a document which can not be interpreted
   * again.
   *
   * @return information whether the filter constructs a document which can not be interpreted again
   * @author Andreas Bröker
   * @date 08.07.2006
   */
  ...
  /**
   * Returns file extension of the filter. Returns null if the document is not supported by the
   * filter.
   *
   * @param document document to be used
  ...
  /**
   * Returns file extension of the filter. Returns null if the document type is not supported by the
   * filter.
   *
   * @param documentType document type to be used
   * @return file extension of the filter
  ...
  /**
   * Returns name of the filter. Returns null if the submitted document is not supported by the
   * filter.
   *
   * @param document document to be used
  ...
  /**
   * Returns name of the filter. Returns null if the submitted document type is not supported by the
   * filter.
   *
   * @param documentType document type to be used
   * @return name of the filter
