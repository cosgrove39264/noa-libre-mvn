...
/**
 * Descriptor of a document. A document descriptor can be used in order control the load or store
...
public class DocumentDescriptor implements IDocumentDescriptor {
  ...
  /**
   * Returns information whether the document is a template. The default value is
   * <code>false</code>
   *
  ...
  /**
   * Returns information whether the document should be opened read only. The default value is
   * <code>false</code>
   *
  ...
  /**
   * Sets information whether the document should be opened read only. The default value is
   * <code>false</code>
   *
  ...
  /**
   * Returns information whether the document should be opened as preview. The default value is
   * <code>false</code>
   *
  ...
  /**
   * Sets information whether the document should be opened as preview. The default value is
   * <code>false</code>
   *
  ...
  /**
   * Returns the URL of the document. This is the location of the component in URL syntax. It must
   * be the full qualified URL
   *
  ...
  /**
   * Sets the URL of the document. This is the location of the component in URL syntax. It must be
  ...
  /**
   * Sets the filter definition of the document. This can be used for forcing the document loading
   * to use a special filter type.
   *
