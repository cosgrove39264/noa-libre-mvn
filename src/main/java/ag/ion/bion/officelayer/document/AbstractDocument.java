...
public abstract class AbstractDocument implements IDocument {
   ...
   *
   * @param xComponent OpenOffice.org XComponent interface
   * @param intitialProperties the properties that were used loading the document
   * @throws IllegalArgumentException if the submitted OpenOffice.org XComponent interface is not
   * valid
   * @author Andreas Bröker
   */
   ...
   * Sets selection.
   *
   * @param selection selection to be set
