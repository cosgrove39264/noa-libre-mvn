...
/**
 * A special hash-like structure which saves key value pairs and makes random access to them
 * possible.
 *
...
public class OrderedHashMap {
  ...
  /**
   * Gets the first element in the structure. The internal pointer changes to the first element in
   * the structure.
   *
  ...
  /**
   * Gets the last element in the structure. The internal pointer changes to the last element in the
   * structure.
   *
  ...
  /**
   * Gets the next element in the structure. Returns null if there is no next element. The current
   * position of the element pointer is moved to the next element.
   *
   * @return value the next element.
   */
  public Object getNext() {
    currentPosition = currentPosition > -1 ? currentPosition++ : 0;
    if (currentPosition <= internalCounter
        && internalCounter > -1) { // if internalCounter is -1 the list was not initalized.
