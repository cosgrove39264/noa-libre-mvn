 ...
 * UNO jar files to the search path of a customized class loader, which is used for loading the
...
public final class OfficeLoader {
  ...
  /**
   * This method instantiates a customized class loader with the UNO jar files added to the search
   * path and loads the application class, which is specified as the first parameter in the argument
   * list.
   */
  ...
  /**
   * A customized class loader which is used to load classes and resources from a search path of
   * user-defined URLs.
   */
