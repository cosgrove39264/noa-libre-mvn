...
public class PropertyCollection {
   ...
   */
  public static void setPropertyCollection(PropertyCollection propertyCollection, Object object,
      String[] orderProperties, String[] excludeProperties) {
    try {
      XPropertySet xPropertySet = (XPropertySet) UnoRuntime
          .queryInterface(XPropertySet.class, object);
      if (xPropertySet != null) {
  ...
  public static void setPropertyCollection(PropertyCollection propertyCollection,
      XPropertySet xPropertySet, String[] orderProperties, String[] excludeProperties) {
    try {
      XPropertySetInfo xPropertySetInfo = xPropertySet.getPropertySetInfo();
      ...
      if (orderProperties != null) {
        ...
        for (int i = 0; i < orderProperties.length; i++) {
          try {
            xPropertySet.setPropertyValue(orderProperties[i],
                propertyCollection.getPropertyValue(orderProperties[i]));
          ...
          try {
            if (propertyCollection.containesProperty(name)) {
              if (name.equalsIgnoreCase("NumberFormat")) {
                if (((Integer) propertyCollection.getPropertyValue("NumberFormat")).intValue()
                    == 256) {
                  /**
   ...
   *
   * @param name name of the property
   * @return information whether the property with the submitted name is availble in this collection
   */
