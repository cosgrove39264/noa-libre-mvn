...
public class TextDocument extends AbstractDocument implements ITextDocument {
  ...
  public TextDocument(XTextDocument xTextDocument, PropertyValue[] initialProperties)
    ...
    this.xMultiServiceFactory = (XMultiServiceFactory) UnoRuntime
  ...
  /**
   * Returns OpenOffice.org XTextDocument interface. This method is not intended to be called by
   * clients.
   *
   ...
   * @param zoomValue the value of the zoom, does only take afect if zoom type is set to
   * DocumentZoomType.BY_VALUE. Values between 20 and 600 are allowed.
