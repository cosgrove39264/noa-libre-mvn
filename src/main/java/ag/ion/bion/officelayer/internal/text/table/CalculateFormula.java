...
public class CalculateFormula {
   ...
   * @author Miriam Sutter
   */
  public static double calculate(ITextTableFormulaElement[] elements, Arguments arguments,
      String formula) throws TextException {
    double result = 0.0;
    ...
    if (elements.length == 0) {
      ...
      for (int i = 0; i < elements.length; i++) {
        ...
        calcString = calcString.substring(0, index) + "<HELP" + count + ">" + calcString
            .substring(index + helpString.length());
