...
public class TextTableCellRangeCloneService extends AbstractCloneService {
   ...
   * @author Miriam Sutter
   */
  public TextTableCellRangeCloneService(ITextTableCellRange textTableCellRange)
    ...
    try {
      ...
      if (ITextRange.class.isAssignableFrom(position.getType())) {
        ...
        if (range != null) {
          ...
          newTable.getProperties()
              .setTableColumnSeparators(textTablePropertyStore.getTableColumnSeparators());
        } else {
      ...
      if (newTable != null) {
        ...
        if (generateReturnValue) {
          ITextTableCellRange textTableCellRange = newTable
              .getCellRange(columnStart, rowStart, columnArrayLength, rowArrayLength);
