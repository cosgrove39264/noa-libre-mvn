...
public class FormService implements IFormService {
   ...
   * @throws IllegalArgumentException if the submitted document or the OpenOffice.org XFormsSupplier
  ...
  public FormService(IDocument document, XDrawPage xDrawPage) throws IllegalArgumentException {
    if (document == null) {
      throw new IllegalArgumentException(
          Messages.getString("FormService.exception_document_invalid")); //$NON-NLS-1$
    }
    this.document = document;
    if (xDrawPage == null) {
      throw new IllegalArgumentException(
          Messages.getString("FormService.exception_xdrawPage_interface_invalid")); //$NON-NLS-1$
    }
  ...
  /**
   * Returns the forms for the given form name as an array. There will be only more than one form if
   * the given form name occurs more than once.
   *
      ...
      if (formName != null) {
        ...
        if (formsSupplier != null) {
          ...
          XIndexContainer indexContainer = (XIndexContainer) UnoRuntime
              .queryInterface(XIndexContainer.class, nameContainer);
  ...
  /**
   * Returns the OpenOffice.org XEventAttacherManager interface for the given form, or null if not
   * available.
   *
   * @param form the form to be used
   * @return the OpenOffice.org XEventAttacherManager interface for the given form, or null
    ...
    try {
      if (form != null) {
        ...
        if (formsSupplier != null) {
          ...
          int len = indexContainer.getCount();
          for (int i = 0; i < len; i++) {
            XForm tmpForm = (XForm) UnoRuntime
                .queryInterface(XForm.class, indexContainer.getByIndex(i));
            if (tmpForm != null && UnoRuntime.areSame(form.getXFormComponent(), tmpForm)) {
              XEventAttacherManager tmpEventAttacherManager =
                  (XEventAttacherManager) UnoRuntime
                      .queryInterface(XEventAttacherManager.class, tmpForm);
          ...
          for (int i = 0; i < len; i++) {
            ...
            if (tmpForm != null && UnoRuntime.areSame(form.getXFormComponent(), tmpForm)) {
              XIndexContainer container = (XIndexContainer) UnoRuntime
                  .queryInterface(XIndexContainer.class, tmpForm);
              ...
              for (int j = 0; j < lenFormPComponents; j++) {
                ...
                if (tmpObject != null) {
                  XFormComponent tmpFormComponent = (XFormComponent) UnoRuntime
                      .queryInterface(XFormComponent.class, tmpObject);
                  if (tmpFormComponent != null && UnoRuntime
                      .areSame(tmpFormComponent, formComponent.getXFormComponent())) {
                    return j;
                  }
                }
              }
            ...
            if (controlShape != null) {
              ...
              if (control != null) {
                XFormComponent xFormComponent = (XFormComponent) UnoRuntime
                    .queryInterface(XFormComponent.class, control);
          ...
          if (xShape != null) {
            ...
            if (controlShape != null) {
              ...
              if (controlModel != null) {
                XFormComponent xFormComponent = (XFormComponent) UnoRuntime
                    .queryInterface(XFormComponent.class, controlModel);
                if (xFormComponent != null) {
              ...
              if (control != null) {
                ...
                if (xFormComponent != null) {
                  XPropertySet propertySet = (XPropertySet) UnoRuntime
                      .queryInterface(XPropertySet.class, xFormComponent);
                  if (propertySet != null && propertySet.getPropertySetInfo()
