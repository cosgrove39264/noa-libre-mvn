...
public class PageService implements IPageService {
  ...
  public int getPageCount() {
    try {
      XDrawPagesSupplier dSupplier = (XDrawPagesSupplier) UnoRuntime
          .queryInterface(XDrawPagesSupplier.class, presentationDocument.getXComponent());
  ...
  public void goToPage(int index) throws PresentationException {
    try {
      ...
      XPresentationPage page = (XPresentationPage) UnoRuntime
          .queryInterface(XPresentationPage.class, pages.getByIndex(index));

      XModel xModel = (XModel) UnoRuntime
          .queryInterface(XModel.class, presentationDocument.getPresentationSupplier());
