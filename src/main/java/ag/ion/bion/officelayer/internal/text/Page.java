...
public class Page implements IPage {
   ...
   * @throws IllegalArgumentException if the submitted text document, startposition or end position
   * is not valid
   * @author Andreas Bröker
   */
  public Page(ITextDocument textDocument, PagePosition startPagePosition,
      PagePosition endPagePosition) throws IllegalArgumentException {
