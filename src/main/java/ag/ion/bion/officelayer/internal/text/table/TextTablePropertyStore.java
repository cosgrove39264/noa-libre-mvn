...
/**
 * The TextTablePropertyStore. Actually does nothing more than that : get a table and stores its
 * properties (noteably : the proeprties are not changned
 *
 * @author Sebastian Rösgen
 * @version $Revision: 10398 $
 */
public class TextTablePropertyStore extends AbstractPropertyStore implements
  ...
  /**
   * Sets the repeat haedline propertie (so this indicates if the headline is to be repeated over
   * serveral pages).
   *
  ...
  /**
   * Analyses the table and fills up the store while doing this. The information are actually being
   * placed in element variables of this class. This method is only called once (its part of the
   * creation process beein invoked by the constructor call).
   *
