...
public class PagePosition {
   ...
   * @author Andreas Bröker
   */
  public PagePosition(ITextDocument textDocument, XTextRange xTextRange)
  ...
  /**
   * Returns text table cell. Returns null if the content of the page position is not a text table
   * cell.
   *
  ...
  public ITextTableCell getTextTableCell() {
    if (getContentType() == TEXT_TABLE_CELL) {
      TextTableCell textTableCell = new TextTableCell(textDocument,
          (XCell) UnoRuntime.queryInterface(XCell.class, xTextRange.getText()));
