...
public class LineCursor implements ILineCursor {
  ...
  private XLineCursor xLineCursor = null;
   ...
   *
   * @param xLineCursor OpenOffice.org XLineCursor interface to be used
   * @throws IllegalArgumentException if the submitted OpenOffice.org XLineCursor interface is not
   * valid
   * @author Markus Krüger
   */
  public LineCursor(XLineCursor xLineCursor) throws IllegalArgumentException {
    if (xLineCursor == null) {
      throw new IllegalArgumentException(
          "Submitted OpenOffice.org XLineCursor interface is not valid.");
    }
  ...
  public boolean isAtStartOfLine() {
    return xLineCursor.isAtStartOfLine();
  }
  ...
  public boolean isAtEndOfLine() {
    return xLineCursor.isAtEndOfLine();
  }
  ...
  public void gotoStartOfLine(boolean mark) {
    xLineCursor.gotoStartOfLine(mark);
  }
  ...
  public void gotoEndOfLine(boolean mark) {
    xLineCursor.gotoEndOfLine(mark);
  }
