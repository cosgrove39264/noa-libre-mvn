...
public class TextTableColumnsSeparator implements ITextTableColumnSeparator {
   ...
   * @throws IllegalArgumentException if the OpenOffice.org TableColumnSeparator struct is not
   * valid
   * @author Markus Krüger
   */
  public TextTableColumnsSeparator(TableColumnSeparator tableColumnSeparator)
