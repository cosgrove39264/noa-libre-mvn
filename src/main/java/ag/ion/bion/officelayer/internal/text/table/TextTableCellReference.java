...
public class TextTableCellReference {
  ...
  public TextTableCellReference(String cellReferenceExpression) throws IllegalArgumentException {
    ...
    if (pointIndex != -1) {
      ...
      if (Character.isLetter(character)) {
        ...
        startCellReference = startCellReference
            .substring(pointIndex + 1, startCellReference.length());
      }
    }
  ...
  /**
   * Returns name of the table to which the text table cell reference is bounded. Returns null if no
   * table is defined.
   *
  ...
  /**
   * Returns information whether this text table cell reference contains a cell with the submitted
   * name.
   *
   * @param cellName name of a text table cell
   * @return informations whether this text table cell reference contains a cell with the submitted
   * name
   * @author Andreas Bröker
   */
  ...
  public boolean containsCell(int columnIndex, int rowIndex) {
    ...
    if (rowIndex >= startRowIndex && rowIndex <= endRowIndex && columnIndex >= startColumnIndex
  ...
  /**
   * Returns information whether this text table cell reference contains the column of the submitted
   * text table cell name.
   *
   * @param cellName name of a text table cell
   * @return informations whether this text table cell reference contains the column of the
   * submitted text table cell name
   * @author Andreas Bröker
   */
   ...
   * @return informations whether this text table cell reference contains the submitted column index
   * @author Andreas Bröker
   */
  ...
  /**
   * Returns information whether this text table cell reference contains the row of the submitted
   * text table cell name.
   *
   * @param cellName name of a text table cell
   * @return information whether this text table cell reference contains the row of the submitted
   * text table cell name
   * @author Andreas Bröker
   */
  ...
  /**
   * Returns information whether this text table cell reference contains a row with the submtted
   * index.
   *
   * @param rowIndex index of a row
   * @return information whether this text table cell reference contains a row with the submtted
   * index
   * @author Andreas Bröker
   */
  ...
  /**
   * Returns information whether this text table cell reference contains a column after the
   * submitted column of the text table cell name.
   *
   * @param cellName name of a text table cell
   * @return information whether this text table cell reference contains a column after the
   * submitted column of the text table cell name
   * @author Andreas Bröker
   */
  ...
  /**
   * Returns information whether this text table cell reference contains a row after the row index
   * of the submitted text table cell name.
   *
   * @param cellName name of a text table cell
   * @return information whether this text table cell reference contains a row after the row index
   * of the submitted text table cell name
   * @author Andreas Bröker
   */
  ...
  /**
   * Returns information whether this text table cell reference contains a row after the submitted
   * row index.
   *
   * @param rowIndex index of a row
   * @return information whether this text table cell reference contains a row after the submitted
   * row index
   * @author Andreas Bröker
   */
  ...
  /**
   * Returns end column index. If the text table cell reference is not a range the method will
  ...
  /**
   * Returns start row index. If the text table cell reference is not a range the method will return
   * the start row index.
   *
   * @return start row index
   * @author Andreas Bröker
  ...
  /**
   * Extends text table cell reference to text table cell range reference on the basis of the
   * submitted index informations. The column range will be completely redefined.
   *
  ...
  public void toColumnRange(int startColumnIndex, int endColumnIndex) throws TextException {
    startCellReference = TextTableCellNameHelper
        .moveColumnIndexTo(startColumnIndex, startCellReference);
    endCellReference = TextTableCellNameHelper
        .moveColumnIndexTo(endColumnIndex, startCellReference);
    modified = true;
  }
  //----------------------------------------------------------------------------
  ...
  public void extendColumnRangeTo(int endColumnIndex) throws TextException {
    ...
    if (endCellReference == null) {
      ...
      if (TextTableCellNameHelper.getColumnIndex(endCellReference) < endColumnIndex) {
        endCellReference = TextTableCellNameHelper
            .moveColumnIndexTo(endColumnIndex, endCellReference);
      }
    }
    modified = true;
  }
  ...
  /**
   * Extends text table cell reference range. If the text table cell reference is not a range, a new
  ...
  public void extendRowRangeTo(int rowIndexTo) throws TextException {
    ...
    if (endCellReference == null) {
      endCellReference = TextTableCellNameHelper
          .moveRowCounterValueTo(rowIndexTo + 1, startCellReference);
    } else {
      endCellReference = TextTableCellNameHelper
          .moveRowCounterValueTo(rowIndexTo + 1, endCellReference);
    }
    modified = true;
  }
  //----------------------------------------------------------------------------
  ...
  public String toString() {
    ...
    return stringBuffer.append(startCellReference).append(RANGE_DELIMITER).append(endCellReference)
        .append(END_REFERENCE).toString();
  }
  //----------------------------------------------------------------------------
}