...
public class DocumentLoader {
  ...
  /**
   * Returns document on the basis of the submitted OpenOffice.org XComponent. Returns null if the
   * document can not be builded.
   *
   * @param xComponent OpenOffice.org XComponent or null if the document can not be builded
  ...
  public static IDocument getDocument(XComponent xComponent, IServiceProvider serviceProvider,
    ...
    if (xServiceInfo.supportsService("com.sun.star.text.TextDocument")) {
      ...
      XPresentationSupplier presentationSupplier = (XPresentationSupplier) UnoRuntime
          .queryInterface(XPresentationSupplier.class,
              xComponent);
      ...
      XOfficeDatabaseDocument xOfficeDatabaseDocument = (XOfficeDatabaseDocument) UnoRuntime
          .queryInterface(XOfficeDatabaseDocument.class,
              xComponent);
    ...
    if (document != null && document instanceof AbstractDocument) {
      ...
      for (int i = 0; i < intitialProperties.length; i++) {
        if (intitialProperties[i].Name.equals("Hidden") && intitialProperties[i].Value
            .equals(Boolean.TRUE)) {
          isHidden = true;
          break;
        }
