...
public class ApplicationInfo implements IApplicationInfo {
  ...
  public ApplicationInfo(IServiceProvider serviceProvider) throws Exception {
    if (serviceProvider == null) {
      throw new Exception(
          "A service provider is needed for the ApplicationInfo. This should not happen.");
    }
  ...
  /**
   * Returns the version of the office application. Returns <code>null</code> if the version is not
   * available.
   *
   * @return the version of the office application or <code>null</code> if the version is not
   * available
   * @throws Exception if retreiving the value fails
   * @author Markus Krüger
   * @date 18.11.2008
  ...
  /**
   * Returns major version of the office application. Returns <code>-1</code> if the major version
   * is not available.
   *
  ...
  /**
   * Returns minor version of the office application. Returns <code>-1</code> if the minor version
   * is not available.
   *
  ...
  /**
   * Returns update version of the office application. Returns <code>-1</code> if the update version
   * is not available.
   *
  ...
  /**
   * Returns the date when the license of the office application was accepted, or <code>null</code>
   * if not available.
   *
   * @return the date when the license of the office application was accepted, or <code>null</code>
   * if not available
   * @throws Exception if retreiving the value fails
   * @author Markus Krüger
   * @date 18.11.2008
  ...
  /**
   * Returns if the first start wizard is already completed as Boolean, or <code>null</code> if not
   * available.
   *
   * @return if the first start wizard is already completed as Boolean, or <code>null</code> if not
   * available
   * @throws Exception if retreiving the value fails
   * @author Markus Krüger
   * @date 18.11.2008
  ...
  /**
   * This method can be used to get any info from the application that is available. (Possible paths
   * and keys can be retrieved with the dumpInfo method). Returns the object described by the path
   * and key, or <code>null</code> if not available.
   *
  ...
  public Object getInfo(String path, String key) throws Exception {
    Object configProviderObject = serviceProvider
        .createService("com.sun.star.comp.configuration.ConfigurationProvider");
    XMultiServiceFactory xConfigServiceFactory = (XMultiServiceFactory) UnoRuntime
    ...
    Object configReadAccessObject = xConfigServiceFactory
        .createInstanceWithArguments(readConfAccess,
            properties);
