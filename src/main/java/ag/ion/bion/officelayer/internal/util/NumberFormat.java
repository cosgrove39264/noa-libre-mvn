...
public class NumberFormat implements INumberFormat {
   ...
   * @throws IllegalArgumentException if the submitted OpenOffice.org XPropertySet interface is not
   * valid
   * @author Andreas Bröker
   * @author Markus Krüger
   */
  public NumberFormat(int formatKey, XPropertySet xPropertySet,
      INumberFormatService numberFormatService) throws IllegalArgumentException {
    if (xPropertySet == null) {
      throw new IllegalArgumentException(
          "Submitted OpenOffice.org XPropertySet interface is not valid.");
    }
