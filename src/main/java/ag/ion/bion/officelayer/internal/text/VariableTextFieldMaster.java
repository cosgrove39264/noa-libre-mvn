...
public class VariableTextFieldMaster implements IVariableTextFieldMaster {
   ...
   * @throws IllegalArgumentException if the submitted text document or OpenOffice.org XPropertySet
   * interface is not valid
   * @author Markus Krüger
   * @date 30.05.2007
   */
  public VariableTextFieldMaster(ITextDocument textDocument, XPropertySet xPropertySet)
   ...
   *
   * @return name of the master of a variable text field or null if a name is not available
   * @author Markus Krüger
   * @date 30.05.2007
   */
  ...
  /**
   * Constructs new variable text field on the basis of this variable text field master. TODO maybe
   * some more parameters are needed???
   *
  ...
  public ITextField constructNewVariableTextField(String content, boolean visible,
    ...
    try {
      XMultiServiceFactory xMultiServiceFactory = (XMultiServiceFactory) UnoRuntime
          .queryInterface(XMultiServiceFactory.class, textDocument.getXTextDocument());
      ...
      VariableTextFieldHelper
          .setContent(content, variableTextField, isFormula, numberFormatService);
      if (numberFormat != null) {
        VariableTextFieldHelper
            .applyNumberFormat(numberFormat, variableTextField, isFormula, numberFormatService);
      }
