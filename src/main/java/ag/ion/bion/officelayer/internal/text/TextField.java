...
public class TextField extends AbstractTextComponent implements ITextField {
   ...
   * @throws IllegalArgumentException if the submitted text document or OpenOffice.org
   * XDependentTextField interface is not valid
   * @author Andreas Bröker
   */
  public TextField(ITextDocument textDocument, XDependentTextField xDependentTextField)
   ...
   * @throws IllegalArgumentException if the submitted text document or OpenOffice.org XTextField
   * interface is not valid
   * @author Andreas Bröker
   */
  public TextField(ITextDocument textDocument, XTextField xTextField)
      throws IllegalArgumentException {
    super(textDocument);

    xDependentTextField = (XDependentTextField) UnoRuntime
        .queryInterface(XDependentTextField.class, xTextField);
    if (xDependentTextField == null) {
      throw new IllegalArgumentException(
          "The submitted OpenOffice.org XTextField interface is not valid");
    }
  }
  //----------------------------------------------------------------------------
  ...
  private void addEventListener(XEventListener xEventListener) {
    XTextField xTextField = (XTextField) UnoRuntime
        .queryInterface(XTextField.class, xDependentTextField);
