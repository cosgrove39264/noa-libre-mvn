...
public class TextTableCell extends AbstractTextComponent implements ITextTableCell {
   ...
   * @throws IllegalArgumentException if the submitted text document or OpenOffice.org XCell
  ...
  public ITextTableCellName getName() {
    if (textTableCellName == null) {
      ...
      try {
        textTableCellName = new TextTableCellName(
            xPropertySet.getPropertyValue("CellName").toString());
  ...
  public ITextTable getTextTable() throws TextException {
    if (textTable == null) {
      try {
        ...
        XPropertySet xPropertySet = (XPropertySet) UnoRuntime
            .queryInterface(XPropertySet.class, xText.getStart());
  ...
  public ITextTableCellPropertyStore getCellPropertyStore(int horizontalPosition,
      int verticalPosition) throws TextException {
   ...
   *
   * @return the page number of the cell, returns -1 if page number could not be determined
   * @author Markus Krüger
   */
  ...
  /**
   * Returns style of the cell paragraph, or null if not available. NOTE: The style of the first
   * found paragraph in the cell will be returned.
   *
  ...
  /**
   * Sets style of the cell paragraph. NOTE: The style will be applied to all paragraphs found in
   * the cell.
   *
