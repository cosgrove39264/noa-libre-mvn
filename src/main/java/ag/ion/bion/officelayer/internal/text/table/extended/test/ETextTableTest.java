...
//import ag.ag.ion.bion.officelayer.text.table.extended.IETextTableCellRange;
...
public class ETextTableTest extends TestCase {
  ...
  public void testETextTable() {
    ...
    try {
      ...
      docu = (ITextDocument) officeApplication.getDocumentService()
          .loadDocument("file:///d:/java/eclipse/workspace/officeapi/test/testETables.sxw");
