...
public class TextTableCellRange implements ITextTableCellRange {
   ...
   * @throws IllegalArgumentException if the submitted text document, OpenOffice.org XCellRange
   * interface or text table range name is not valid
   * @author Andreas Bröker
   */
  public TextTableCellRange(ITextDocument textDocument, XCellRange xCellRange,
      ITextTableCellRangeName textTableCellRangeName) throws IllegalArgumentException {
    if (textDocument == null) {
      throw new IllegalArgumentException("Submitted text document is not valid.");
    }
    if (xCellRange == null) {
      throw new IllegalArgumentException(
          "Submitted OpenOffice.org XCellRange interface is not valid.");
    }
  ...
  public ITextTableCellProperties getCellProperties() {
    XPropertySet xPropertySet = (XPropertySet) UnoRuntime
        .queryInterface(XPropertySet.class, xCellRange);
  ...
  public int getRowCount() {
    return textTableCellRangeName.getRangeEndRowIndex() + 1 - textTableCellRangeName
  ...
  public int getColumnCount() {
    return textTableCellRangeName.getRangeEndColumnIndex() + 1 - textTableCellRangeName
  ...
  public ITextTableCell getCell(String name) throws TextException {
    ...
    try {
      ...
      throw new TextException("Index out of bound Exception", e);
    }
  }
  //----------------------------------------------------------------------------
