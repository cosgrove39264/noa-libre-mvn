...
public class TextContentEnumeration implements ITextContentEnumeration {
   ...
   * @throws java.lang.IllegalArgumentException IllegalArgumentException IllegalArgumentException if
   * the OpenOffice.org interface is not valid
   * @author Andreas Bröker
   * @author Sebastian Rösgen
   */
  public TextContentEnumeration(ITextDocument textDocument, XTextRange xTextRange)
      throws java.lang.IllegalArgumentException {
    if (textDocument == null) {
      throw new java.lang.IllegalArgumentException("Submitted text document is not valid.");
    }
  ...
  public ITextField[] getTextFields() {
    ...
    try {
      while (xTextRangeCompare.compareRegionEnds(textCursor.getStart(), xTextRange.getEnd())
          != -1) {
  ...
  public IParagraph[] getParagraphs() {
    ArrayList arrayList = new ArrayList();
    XEnumerationAccess contentEnumerationAccess = (XEnumerationAccess) UnoRuntime
        .queryInterface(XEnumerationAccess.class, xTextRange);
