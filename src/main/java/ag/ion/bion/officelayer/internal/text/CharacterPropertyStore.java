...
/**
 * Concrete implementation of the ICharacterProeprtyStore. This class stoers properties belonging to
 * characters, thus that after loosing the reference of the original character we still have stored
 * the properties
 *
 ...
 */
public class CharacterPropertyStore extends AbstractPropertyStore implements
