 ...
 */
public class ParagraphPropertyStore extends AbstractPropertyStore implements
  ...
  /**
   * Reads the properties out of the submitted paragraph and thus fills the storage with the gained
   * information.
   *
