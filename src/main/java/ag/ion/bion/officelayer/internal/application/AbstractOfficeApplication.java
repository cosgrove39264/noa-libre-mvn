...
public abstract class AbstractOfficeApplication implements IOfficeApplication {
  ...
  /**
   * Deactivates the office application. This call will not terminate the OpenOffice.org process -
   * it will only dispose the internal communication bridge to OpenOffice.org.
   *
  ...
  /**
   * Returns information whether the office application is active or not. This information is not an
   * indicator for a running native OpenOffice.org process.
   *
  ...
  /**
   * Opens connection to OpenOffice.org. Subclasses must implement this method in order to activate
   * the application and they must supply the constructed connection to the base class.
   *
