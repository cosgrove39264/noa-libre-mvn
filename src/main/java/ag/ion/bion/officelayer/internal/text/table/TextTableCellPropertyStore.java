...
/**
 * "Construct" to store the properties of a table cell, so that even when deleteing the original
 * cell (and thus loosing the reference), we keep the cell information.
 *
 * @author Sebastian Rösgen
 * @author Markus Krüger
 * @version $Revision: 10398 $
 */
public class TextTableCellPropertyStore extends AbstractPropertyStore implements
