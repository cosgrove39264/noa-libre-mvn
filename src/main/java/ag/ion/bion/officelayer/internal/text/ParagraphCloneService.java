...
public class ParagraphCloneService extends AbstractCloneService {
  ...
  public ParagraphCloneService(IParagraph paragraph, ITextDocument document) throws CloneException {
    ...
    this.serviceFactory = (XMultiServiceFactory) com.sun.star.uno.UnoRuntime
        .queryInterface(XMultiServiceFactory.class, document.getXTextDocument());
    try {
  ...
  /**
   * Clones the paragraph to the given position and then returns a reference. If the position is
   * null, then the clone is placed at the end of the document.
   *
  ...
  /**
   * Clones the chosen paragraph to the given position and then returns a reference This method also
   * enables to  adopts the content of the paragraph (the default is to adopt, otherwise the
   * paramter has to be set to false)
   *
   * @param range range to be used
