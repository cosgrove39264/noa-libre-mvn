...
/**
 * A listener beeing implemented in an documenten to get notified whenever there occurs a change.
 *
...
public class DocumentModifyListenerWrapper implements XModifyListener {
  ...
  /**
   * This will get called whenever the document is beeing disposed, or the listener itself gets
   * disposed.
   *
