...
public class TextFieldMaster implements ITextFieldMaster {
   ...
   * @author Andreas Bröker
   */
  public TextFieldMaster(ITextDocument textDocument, XPropertySet xPropertySet)
   ...
   *
   * @return name of the master of a textfield or null if a name is not available
   * @author Andreas Bröker
   */
   ...
   *
   * @return content of the master of a textfield or null if a content is not available
   * @author Andreas Bröker
   */
