...
/**
 * A wrapper to contain the listener structure which will be fired whenever changed (remvoes) of
 * elements will occur.
 *
...
public class ElementDisposeListenerWrapper implements XEventListener {
  ...
  /**
   * Gets called when the element beeing holding this listener gets disposed.
   *
