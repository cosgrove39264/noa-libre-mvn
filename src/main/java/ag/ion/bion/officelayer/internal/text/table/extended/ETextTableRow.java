...
public class ETextTableRow implements IETextTableRow {
   ...
   */
  public ETextTableRow(IETextTableCellRange textTableCellRange, int rowNumber, ETextTable textTable)
    ...
    for (int i = 0; i < tableCells.length; i++) {
      textTableCells[i] = new ETextTableCell(tableCells[i].getTableCell(),
          TextTableCellNameHelper.getColumnCharacter(tableCells[i].getName().getName() + rowNumber),
          textTable);
    }
  }
  //----------------------------------------------------------------------------
