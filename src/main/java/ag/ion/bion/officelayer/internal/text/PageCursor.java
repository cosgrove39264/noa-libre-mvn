...
public class PageCursor implements IPageCursor {
   ...
   * @throws IllegalArgumentException if the submitted OpenOffice.org XPageCursor interface is not
   * valid
   * @author Markus Krüger
   */
  public PageCursor(XPageCursor xPageCursor) throws IllegalArgumentException {
    if (xPageCursor == null) {
      throw new IllegalArgumentException(
          "Submitted OpenOffice.org XPageCursor interface is not valid.");
    }
