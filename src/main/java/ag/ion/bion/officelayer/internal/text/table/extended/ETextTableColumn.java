  ...
  public IETextTableCellRange getCellRange() throws Exception {
    ...
    if (textTableCellRanges.length > 0) {
      ITextTableCellRangeName tableCellRangeName = new TextTableCellRangeName(
          textTableCellRanges[0].getRangeName().getRangeStartColumnIndex(),
          textTableCellRanges[0].getRangeName().getRangeStartRowIndex(),
          textTableCellRanges[textTableCellRanges.length - 1].getRangeName()
              .getRangeEndColumnIndex(),
          endRow - 1);

      ETextTableCellRange textTableCellRange = new ETextTableCellRange(textTableCellRanges,
          tableCellRangeName, textTable);
