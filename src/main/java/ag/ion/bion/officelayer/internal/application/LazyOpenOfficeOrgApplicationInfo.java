...
/**
 * Information provider of an OpenOffice.org application.
 *
 * @author Andreas Bröker
 * @author Markus Krüger
 * @version $Revision: 11681 $
 */
public class LazyOpenOfficeOrgApplicationInfo extends
    AbstractLazyApplicationInfo implements ILazyApplicationInfo {
  ...
  /**
   * Constructs new LazyOpenOfficeOrgApplicationInfo.
   *
   ...
   * @author Markus Krüger
   */
  public LazyOpenOfficeOrgApplicationInfo(String home,
