...
public class TextFieldService implements ITextFieldService {
  ...
  private static final String USER_TEXTFIELD_MASTER_PREFIX =
      ITextFieldService.USER_TEXTFIELD_MASTER_ID
          + ".";
  private static final String VARIABLES_TEXTFIELD_MASTER_PREFIX =
      ITextFieldService.VARIABLES_TEXTFIELD_MASTER_ID
          + ".";
