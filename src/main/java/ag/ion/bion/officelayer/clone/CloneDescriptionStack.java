...
/**
 * The CloneDescriptionStack contains all PropertyElements held by a clone service for cloning
 * purpose. This structure only serves as a storage for the cloning process controled by the
 * ICloneService
 *
...
public class CloneDescriptionStack implements ICloneDescriptionStack {
  ...
  /**
   * Adds a new element to the stack (this weill be placed on top automagically, (this is pretty
   * obvious cause we're working with a stack, I know, I know).
   */
