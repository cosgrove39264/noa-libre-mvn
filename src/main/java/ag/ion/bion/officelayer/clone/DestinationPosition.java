...
/**
 * Concrete implementation of the IDestinationPosition. With this class its possible to give a newly
 * cloned object a target destiantion, so that it "knows" wherer to be placed.
 *
