...
public class OfficeApplicationRuntime {
   ...
   * @author Andreas Bröker
   */
  public static final IOfficeApplication getApplication(Map configuration)
  ...
  public static IOfficeApplication getApplication() throws OfficeApplicationException {
    ...
    configuration
        .put(IOfficeApplication.APPLICATION_TYPE_KEY, IOfficeApplication.LOCAL_APPLICATION);
   ...
   * @throws OfficeApplicationException if the office application assistant can not be provided
   * @author Andreas Bröker
   */
  public static IApplicationAssistant getApplicationAssistant(String nativeLibPath)
      throws OfficeApplicationException {
