 ...
 * @deprecated
 */
public class LocalOfficeApplicationConfiguration extends AbstractOfficeConfiguration implements
  ...
  public void setApplicationHomePath(String applicationHomePath) throws IllegalArgumentException {
    if (applicationHomePath == null) {
      throw new IllegalArgumentException(
          "The submitted home path for OpenOffice.org is not valid.");
    }
