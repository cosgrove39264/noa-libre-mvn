...
public interface IOfficeProgressMonitor {
  ...
  /**
   * Returns information whether the progress monitor needs to be notified about the end of the main
   * task.
   *
   * @return information whether the progress monitor needs to be notified about the end of the main
   * task
   * @author Andreas Bröker
   */
