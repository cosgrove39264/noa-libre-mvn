...
/**
 * Container that can hold property keys for different properties. Is used for cloning cell formats
 * and to decide wich properties to clone, for example.
 *
...
public class PropertyKeysContainer {
  ...
  /**
   * Adds property keys for the property with the given id to this container. If the properties id
   * is already in this container it will be overwritten.
   *
