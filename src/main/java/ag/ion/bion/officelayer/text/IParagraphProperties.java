...
public interface IParagraphProperties extends IProperties {
   ...
   **/
  public static final String TYPE_ID = "ag.ag.ion.bion.officelayer.text.ParagraphProperties";
  ...
  /**
   * Returns name of the paragraph style. Returns null if a name of a paragraph style is not
   * available.
   *
