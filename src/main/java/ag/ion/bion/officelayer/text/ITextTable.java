...
public interface ITextTable extends ITextContent, ICloneServiceProvider {
  ...
  /**
   * The function getCellRangeByPosition of the interface XCellRange works not properly. A column
   * index over 51 causes a dead lock in OpenOffice.org. Therefore we do not support tables which
   * have more than 52 columns.
   */
