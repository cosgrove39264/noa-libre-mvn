...
public class TextTableCellNameHelper {
  ...
  /**
   * Moves row counter value. Use positive count values in order to move the row counter value
  ...
  /**
   * Calculates the concrete int representation of the column.
   *
   * @param level the column letter position (for example <GHU12> would have 'G' as 2, 'H' as 1 and
   * 'U' as 0
  ...
  /**
   * Moves column index. Use positive count values in order to move the column index forward and
   * negative values to move it backward.
   *
   ...
   * @return next column name on the basis of the submitted name of a column
   * @author Andreas Bröker
   */
