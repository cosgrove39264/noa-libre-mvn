...
public interface ITextFieldService {
  ...
  /**
   * Returns master of a user textfield with the submitted name. Returns null if a user textfield
   * with the submitted name is not available.
   *
   * @param name name of the master of the user textfield
   * @return master of a user textfield with the submitted name or null if a user textfield with the
   * submitted name is not available
   ...
   * @author Markus Krüger
   */
  public ITextFieldMaster[] getUserTextFieldMasters(String prefix, String suffix)
   ...
   * @param placeholderType the type of the placeholder found in static members of
   ...
   * @date 30.05.2007
   */
  public ITextField createPlaceholderTextField(String name, String hint, short placeholderType)
      throws TextException;
  //---------------------------------------------------------------------------- 
  ...
  /**
   * Creates a new variable textfield master and returns it, or returns the one that already exists,
   * if it does. TODO maybe some more parameters are needed???
   *
   * @param name name of the variable textfield master
   * @param variableType the type of the variable master found in static members of
   * com.sun.star.text.SetVariableType (i.e. SetVariableType.STRING)
   ...
   * @date 30.05.2007
   */
  public IVariableTextFieldMaster createVariableTextFieldMaster(String name, short variableType)
      throws TextException;
  //----------------------------------------------------------------------------
