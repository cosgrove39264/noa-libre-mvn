...
public class OSHelper {
  ...
  public static final String OS_NAME = System
      .getProperty("os.name");                          //$NON-NLS-1$
  public static final boolean IS_WINDOWS = getOSMatchesName(
      "Windows");                            //$NON-NLS-1$
  public static final boolean IS_LINUX =
      getOSMatchesName("Linux") || getOSMatchesName("LINUX"); //$NON-NLS-1$ //$NON-NLS-2$
  public static final boolean IS_MAC =
      getOSMatchesName("Mac") || getOSMatchesName("Mac OS X"); //$NON-NLS-1$ //$NON-NLS-2$
