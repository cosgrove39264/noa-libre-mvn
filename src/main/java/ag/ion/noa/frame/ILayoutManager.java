...
public interface ILayoutManager {
   ...
   */
  public static final String URL_TOOLBAR_EXTRUSIONOBJECTBAR =
      URL_PREFIX_TOOLBAR + "/extrusionobjectbar";
  /**
   * Resource URL of the toolbar fontworkobjectbar.
   */
  public static final String URL_TOOLBAR_FONTWORKOBJECTBAR =
      URL_PREFIX_TOOLBAR + "/fontworkobjectbar";
  /**
   * Resource URL of the toolbar fontworkshapetypes.
   */
  public static final String URL_TOOLBAR_FONTWORKSHAPETYPES =
      URL_PREFIX_TOOLBAR + "/fontworkshapetypes";
  /**
   ...
   */
  public static final String URL_TOOLBAR_FORMSNAVIGATIONBAR =
      URL_PREFIX_TOOLBAR + "/formsnavigationbar";
  /**
   ...
   */
  public static final String URL_TOOLBAR_FORMSTEXTOBJECTBAR =
      URL_PREFIX_TOOLBAR + "/formtextobjectbar";
  /**
   ...
   */
  public static final String URL_TOOLBAR_GRAPHICOBJECTBAR =
      URL_PREFIX_TOOLBAR + "/graphicobjectbar";
  /**
   ...
   */
  public static final String URL_TOOLBAR_MOREFORMCONTROLS =
      URL_PREFIX_TOOLBAR + "/moreformcontrols";
  /**
  ...
  /**
   * Hide UI element with the submitted resource URL. Automatically perist changes.
   *
