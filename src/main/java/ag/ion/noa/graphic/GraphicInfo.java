...
public class GraphicInfo {
   ...
   *
   * @param imageInputStream the input stream of the image (this will create a temporary file) Also
   * closes the stream.
   * @param width the width in pixel
   * @param widthPixel if the width is described as pixels, otherwise it is assumed that the width
   * is in thenth millimeter
   * @param height the height in pixel
   * @param heightPixel if the height is described as pixels, otherwise it is assumed that the
   * height is in thenth millimeter
   * @param verticalAlignment the vertical alignment. Possible values are described in {@link
   * VertOrientation}
   * @param horizontalAlignment the horizontal alignment. Possible values are described in {@link
   * HoriOrientation}
   * @param anchor the anchor type of the image. Possible values are described in {@link
   * TextContentAnchorType}
   * @throws NOAException if creation by input stream fails
   * @author Markus Krüger
   * @date 09.07.2007
   */
  public GraphicInfo(InputStream imageInputStream, int width,
      boolean widthPixel, int height, boolean heightPixel,
      short verticalAlignment, short horizontalAlignment,
      TextContentAnchorType anchor) throws NOAException {
   ...
   * @date 09.07.2007
   */
  public GraphicInfo(String url, int width, boolean widthPixel, int height,
      boolean heightPixel, short verticalAlignment,
  ...
  /**
   * Returns the vertical alignment of the image. Possible values are described in {@link
   * VertOrientation}
   *
  ...
  /**
   * Returns the horizontal alignment of the image. Possible values are described in {@link
   * HoriOrientation}
   *
  ...
  /**
   * Returns the anchor of the image, or null. Possible values are described in {@link
   * TextContentAnchorType}
   *
   ...
   * @date 09.07.2007
   */
  private void init(String url, int width, boolean widthPixel, int height,
      boolean heightPixel, short verticalAlignment,
      short horizontalAlignment, TextContentAnchorType anchor) {
  ...
  /**
   * Sets the url and fixes it if needed.
   *
  ...
  private void setURL(String url) {
    ...
    if (!this.url.startsWith("file:///")) {
      if (this.url.startsWith("file://")) {
        this.url = this.url.replace("file://", "file:///");
