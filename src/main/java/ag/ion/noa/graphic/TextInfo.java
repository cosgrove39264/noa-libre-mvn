...
/**
 * Info class for text shapes in a text document. It contains information like height and width of
 * the shape and the containing text.
 *
 * @author Jan Reimann
...
public class TextInfo {
   ...
   * @throws IllegalArgumentException if the OpenOffice.org interface or the document or text info
   * is not valid
   * @author Jan Reimann
   * @date 20.08.2009
   */
  ...
  /**
   * Returns the vertical alignment of the text shape. Possible values are described in {@link
   * VertOrientation}
   *
  ...
  /**
   * Returns the horizontal alignment of the text shape. Possible values are described in {@link
   * HoriOrientation}
   *
  ...
  /**
   * Returns the background color of the text shape, or -1 if not set (in this case it will be
   * transparent).
   *
   * @return the background color of the text shape, or -1 if not set (in this case it will be
   * transparent)
   * @author Jan Reimann
   * @date 20.08.2009
   */
  ...
  /**
   * Returns the anchor of the text shape, or null. Possible values are described in {@link
   * TextContentAnchorType}
   *
