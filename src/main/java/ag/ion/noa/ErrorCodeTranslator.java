...
public class ErrorCodeTranslator {
   ...
   */
  public static final String ERRCODE_IO_ABORT_MESSAGE = Messages
      .getString("ErrorCodeTranslator_io_abort"); //$NON-NLS-1$
  /**
   ...
   */
  public static final String ERRCODE_IO_CANTWRITE_MESSAGE = Messages
      .getString("ErrorCodeTranslator_io_cantwrite"); //$NON-NLS-1$
  /**
   ...
   * @return message for the submitted error code or null if a message is not available
   * @author Andreas Bröker
   * @date 21.02.2006
   */
