...
public class PrintProperties implements IPrintProperties {
   ...
   *
   * @param copyCount the number of copies to print (values less then 1 will result in a copy count
   * of 1)
   * @author Markus Krüger
   * @date 16.08.2007
   */
   ...
   * @param copyCount the number of copies to print (values less then 1 will result in a copy count
   * of 1)
   * @param pages the pages to print (e.g. "1, 3, 4-7, 9-"), or null for default TODO: This format
   * is not checked yet, so validate it yourself for now
   * @author Markus Krüger
   * @date 16.08.2007
   */
