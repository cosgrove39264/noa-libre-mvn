 ...
 */
public class Annotation extends AbstractTextComponent implements IAnnotation, ITextContent,
    ITextComponent {
   ...
   * @date 13.07.2006
   */
  public Annotation(ITextDocument textDocument, ITextField textField)
  ...
  public Annotation(ITextDocument textDocument, XDependentTextField xDependentTextField) {
    super(textDocument);
    Assert.isNotNull(xDependentTextField, XDependentTextField.class, this);
  ...
  public String getText() {
    XServiceInfo info = (XServiceInfo) UnoRuntime
        .queryInterface(XServiceInfo.class, getXTextContent());
    if (info.supportsService(ITextFieldService.ANNOTATION_TEXTFIELD_ID)) {
      XPropertySet properties = (XPropertySet) UnoRuntime
          .queryInterface(XPropertySet.class, getXTextContent());
      try {
   ...
   *
   * This method is not part of the public API. It should be never used from outside.
   *
