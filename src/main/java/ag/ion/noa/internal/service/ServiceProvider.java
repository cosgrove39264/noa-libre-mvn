...
public class ServiceProvider implements IServiceProvider {
  ...
  /**
   * Returns service with the submitted name. Returns null if the a service with the submitted name
   * is not available.
   *
   * @param serviceName service name to be used
   * @return service with the submitted name or null if the a service with the submitted name is not
   * available
  ...
  /**
   * Returns service with the submitted name and internal context. Returns null if the a service
  ...
  public Object createServiceWithContext(String serviceName) throws NOAException {
    try {
      return officeConnection.getXMultiComponentFactory()
          .createInstanceWithContext(serviceName, officeConnection.getXComponentContext());
    } catch (Throwable throwable) {
      throw new NOAException(throwable);
    }
  }
