 ...
 * ************************************************************************** * NOA (Nice Office
 * Access) * ------------------------------------------------------------------------ * * The
 * Contents of this file are made available subject to * the terms of GNU Lesser General Public
 * License Version 2.1. * * GNU Lesser General Public License Version 2.1 *
 * ======================================================================== * Copyright 2003-2006 by
 * IOn AG * * This library is free software; you can redistribute it and/or * modify it under the
 * terms of the GNU Lesser General Public * License version 2.1, as published by the Free Software
 * Foundation. * * This library is distributed in the hope that it will be useful, * but WITHOUT ANY
 ...
 * * * Contact us: * http://www.ion.ag * http://ubion.ion.ag * info@ag.ion.ag * *
 * **************************************************************************
 */
/*
...
public class OfficeBeanTest extends TestCase {
  ...
  private static Logger LOGGER = Logger.getLogger("ag.ag.ion");
  ...
  public static void main(String[] args) throws OfficeApplicationException {
    ...
    if (args.length == 0) {
      ...
      testOfficeBean
          .remoteTestPDF(new File(args[2]), new File(args[3]), args[0], Integer.valueOf(args[1]));
    } else {
      System.out.println(
  ...
  public void remoteTestPDF(File source, File target, String host, int port) {
    ...
    configuration
        .put(IOfficeApplication.APPLICATION_TYPE_KEY, IOfficeApplication.REMOTE_APPLICATION);
    ...
    try {
      ...
      application.getDocumentService().loadDocument(source.getAbsolutePath())
          .getPersistenceService().export(new FileOutputStream(target), PDFFilter.FILTER);
  ...
  /**
   * Test the OpenOffice.org Bean by creating an empty odt file, opening it, creating a pdf and
   * cleanup
   *
  ...
  public void test(String officeHome) throws OfficeApplicationException {
    ...
    if (officeHome == null) {
      ...
      System.out
          .println(appInfo.getClass() + " - Office major version:" + appInfo.getMajorVersion());
...
//         xStorable.storeToURL(url.toString(), properties);
      application.getDocumentService().loadDocument(file.getAbsolutePath()).getPersistenceService()
