...
/**
 * Adapter for document URLs. This adapter can be used in order to build valid document URLs for
 * loading and storing.
 *
...
public class URLAdapter {
  ...
  public static String adaptURL(String url) throws MalformedURLException, UnknownHostException {
    ...
    if (!host.equals(EMPTY_STRING)) {
      url = protocol + PROTOCOL_DEVIDER + PATH_DEVIDER_CHAR + PATH_DEVIDER_CHAR + host + portString
          + path;
      ...
      url = protocol + PROTOCOL_DEVIDER + PATH_DEVIDER_CHAR + PATH_DEVIDER_CHAR + PATH_DEVIDER_CHAR
          + path;
    }
