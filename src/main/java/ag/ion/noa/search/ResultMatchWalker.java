...
public class ResultMatchWalker {
  ...
  /**
   * Moves to the next match. Returns information whether the move to the next match was
   * successfully.
   *
   * @return information whether the move to the next match was successfully
   * @author Andreas Bröker
   * @date 12.07.2006
   */
   ...
   *
   * @return information whether a previous match is available
   * @author Andreas Bröker
   * @date 12.07.2006
   */
  ...
  /**
   * Moves to the previous match. Returns information whether the move to the previous match was
   * successfully.
   *
   * @return information whether the move to the previous match was successfully
   * @author Andreas Bröker
   * @date 12.07.2006
   */
