...
public class SearchDescriptor implements ISearchDescriptor {
   ...
   *
   * @return information whether the search content is case sensitive
   * @author Andreas Bröker
   * @date 09.07.2006
   */
   ...
   *
   * @param useRegularExpression information whether the search content is case sensitive
   * @author Andreas Bröker
   * @date 09.07.2006
   */
   ...
   * Sets information whether the search content is case sensitive
   *
   * @param isCaseSensitive information whether the search content is case sensitive
   * @author Andreas Bröker
   * @date 09.07.2006
   */
   ...
   *
   * @return information whether only complete words should be searched
   * @author Andreas Bröker
   * @date 09.07.2006
   */
   ...
   *
   * @param useCompleteWords information whether only complete words should be searched
   * @author Andreas Bröker
   * @date 09.07.2006
   */
   ...
   *
   * @return information whether a similarity search should be done
   * @author Andreas Bröker
   * @date 13.07.2006
   */
   ...
   *
   * @param useSimilaritySearch information whether a similarity search should be done
   * @author Andreas Bröker
   * @date 13.07.2006
   */
